...
namespace UtilityLibrary.FTPOperator
{
    public class FtpWeb
    {
        string ftpServerIP;
        ...
        public void Upload(string filename)
        {
            ...
            {
               //nsert_Standard_ErrorLog.Insert("FtpWeb", "Upload Error --> " + ex.Message);
            }
        }
        ...
        public void Download(string filePath, string fileName)
        {
            ...
            {
                //_Standard_ErrorLog.Insert("FtpWeb", "Download Error --> " + ex.Message);
            }
        }
        ...
        public void RemoveDirectory(string folderName)
        {
            ...
            {
                //sert_Standard_ErrorLog.Insert("FtpWeb", "Delete Error --> " + ex.Message + "  文件名:" + folderName);
            }
        }
